...
@endsection
@section('icon')
<link rel="shortcut icon" href="{{ asset('/') }}/front-end/images/category.png"/>
@endsection
@section('body')
<div class="banner1">
			<div class="container">
							...
							<div class="col-md-3 product-agileinfo-grid">
								<div class="categories">
									...
									<ul class="tree-list-pad">
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span><a href="{{ route('category-product',['id'=>$category->id]) }}">{{$category->category_name}}</a></label>
