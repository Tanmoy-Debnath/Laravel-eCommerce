                ...
                <div class="caption">
                  ...
                  <div class="col-md-3 cap-left simpleCart_shelfItem">
                    <div class="grid-arr">
                      <div  class="grid-arrival">
                        <figure>
                          <a href="{{ route('product-details', ['id'=>$newArrival->id, 'name'=>$newArrival->product_name]) }}">
                            <div class="grid-img">
                              <img  src="{{ asset($newArrival->product_image) }}" class="img-responsive" alt="">
                            </div>
                            <div class="grid-img">
                              <img  src="{{ asset($newArrival->product_image) }}" class="img-responsive"  alt="">
                            </div>
                      ...
                      <div class="women">
                        <h6><a href="">{{ $newArrival->product_name }}</a></h6>
                        <span class="size">XL / XXL / S </span>
                          <p ><em class="item_price">TK. {{ $newArrival->product_price }}</em></p>
                        <a href="{{ route('product-details', ['id'=>$newArrival->id, 'name'=>$newArrival->product_name]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                      </div>
                    </div>
                  </div>
                  @endforeach
